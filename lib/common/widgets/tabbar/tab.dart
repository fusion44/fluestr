...
class FluestrManyTab extends StatefulWidget {
  ...
  @override
  _FluestrManyTabState createState() => _FluestrManyTabState();
}

class _FluestrManyTabState extends State<FluestrManyTab> {
  @override
